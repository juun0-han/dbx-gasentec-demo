...
Add KPI cards for total send-out, average uptime, average BOG rate, and total maintenance cost. Add a monthly send-out line chart, a site uptime ranking, an asset-category downtime and maintenance-cost comparison, a BOG-rate versus uptime chart, and an ALARM/incident table. Add filters for operation_month, region, terminal_type, asset_category, and maintenance_type. Use the Metric View measures and mark the data as synthetic demonstration data.
```
